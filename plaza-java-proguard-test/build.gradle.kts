...
dependencies {
    testImplementation(project(":plaza-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../plaza-java-core/src/main/resources/META-INF/proguard/plaza-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../plaza-java-core/src/main/resources/META-INF/proguard/plaza-java-core.pro",

...
private constructor(
     ...
     */
    fun attribution(): Optional<String> = body.attribution()
     ...
     *   server responded with an unexpected value).
     */
    fun license(): Optional<String> = body.license()
     ...
     *   server responded with an unexpected value).
     */
    fun strictMode(): Optional<Boolean> = body.strictMode()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.strictMode] with `strictMode.orElse(null)`. */
        fun strictMode(strictMode: Optional<Boolean>) = strictMode(strictMode.getOrNull())

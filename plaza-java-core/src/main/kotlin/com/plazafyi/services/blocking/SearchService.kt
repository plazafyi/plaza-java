...
interface SearchService {
    ...
    fun query(params: SearchQueryParams): FeatureCollection = query(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun query(params: SearchQueryParams): HttpResponseFor<FeatureCollection> =
